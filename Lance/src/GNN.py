...
class GNN(torch.nn.Module):
    ...
    def __init__(   self, 
        ...
        Net_Name: A name given to the specified GNN architecture. Useful for storing performance
        data (accuracy, F1, etc.) for graphing or other analysis.
        ...
        # Assign object the Net_Name attribute
    ...
    def Get_State(self) -> Dict:
        ...
        State   = { "Net Name"              : self.Net_Name,
                    "Conv Activation"       : self._Get_Activation_String(self.Conv_Activation),
    ...
    def Copy(self):
        ...
        Copy : GNN = GNN(   Net_Name            = State['Net Name'],
