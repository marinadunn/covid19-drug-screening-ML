...
class LigandGraphIMDataset(InMemoryDataset):
    ...
    def process(self) -> None:
        ...
        for m in range(Num_Molecules):
            ...
            # Now, set up the feature vector matrix. This holds the non-coordinate features 
            # of the atoms. Recall that at this stage, ligand_data is a Num_Atoms x 22 matrix 
            # we only want features 3 - 21. 
